	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">{{trans("messages.login_header")}}</div>
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								<button type="submit" class="btn btn-primary">{{trans("messages.login_button")}}</button>

								<a class="btn btn-link" href="{{ url('/password/email') }}">{{trans("messages.forgot_password")}}</a>
							</div>
						</div>
					</form>
				</div>
